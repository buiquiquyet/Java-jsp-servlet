...
<body>
    ...
    <div id="wrapper">	
        <form action="dangki" id="form-login"  method="post">
            <h1 class="form-heading">Đăng kí nhân viên</h1>
            ...
            <input type="submit" value="Đăng kí" class="form-submit">
                        <a class="dropdown-item"  href="index1.jsp" ><i class="fa fa-sign-out pull-right"></i> Back</a>
