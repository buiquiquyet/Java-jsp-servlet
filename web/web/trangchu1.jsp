    ...
    <div class="grid">
        <div class="col__left">
            <ul class="col__left--list">
                ...
                <a href="phongControl" class="col__left--item"><i class="fa fa-calendar-days icon"></i>Nhập phòng</a>
        ...
        <div class="col__right">
            <div>
                ...
                <form action="timFull" method="post" class="col__right--form">
            ...
            <div class="btn__button">
                <a href="phongControl" class="button__load">LOAD</a>
            </div>
            <%
                int i = 1;
