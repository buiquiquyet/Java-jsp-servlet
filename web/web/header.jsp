        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="home" class="site_title"><i class="fa fa-home"></i> <span>Admin</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="home"><i class="fa fa-home"></i> Danh sách sinh viên </a>  
                     <li><a href="phong1"><i class="fa fa-bars"></i> Danh sách phòng </a>    
                  </li>

                    <li><a href="phongControl"><i class="fa fa-home"></i> Nhập phòng </a>
                 
                  </li>
                      </li>

                    <li><a href="phongControl"><i class="fa fa-home"></i> Tiền phòng </a>
            ...
            <div class="sidebar-footer hidden-small">
              ...
              <a data-toggle="tooltip" data-placement="top" title="Lock">
                ...
                <a data-toggle="tooltip" data-placement="top" title="Logout" href="admin.jsp" >
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" style="padding-left: 15px;">
                  ...
                  <a class="dropdown-item"  href="javascript:;">Help</a>
                    <a class="dropdown-item"  href="admin.jsp" ><i class="fa fa-sign-out pull-right"></i> Login</a>
					 <a class="dropdown-item"  href="adminDangki.jsp" ><i class="fa fa-sign-out pull-right"></i> Sign Up</a>
