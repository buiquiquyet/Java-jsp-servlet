 ...
 * @author ADMIN
 */
@WebServlet(name = "nhanvienDssvPhong", urlPatterns = {"/nhanvienDssvPhong"})
@MultipartConfig
public class nhanvienDssvPhong extends HttpServlet {
...
//           List<manager> list = s.getPhongxemSv(tenphong);
//           
//           
...
//                     }
//       
//        request.getRequestDispatcher("nhanvienDssvPhong.jsp").forward(request, response);
       ...
       // PrintWriter out = response.getWriter();
        ...
        jsonObject.put("data1", b);
        jsonObject.put("data2", list);
