...
//        request.getRequestDispatcher("editPhong.jsp").forward(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        //processRequest(request, response);
        //String id = request.getParameter("id");
          String tenphong = request.getParameter("tenp_edit");
        //String giatien = request.getParameter("giatien");
        String trangthai = request.getParameter("tt_edit");
        String soluong = request.getParameter("sl_edit");
//        PrintWriter out = response.getWriter();
//               
...
//                      out.println(soluong);
       account a = new account();
        a.updatePhong( tenphong,trangthai,soluong);
